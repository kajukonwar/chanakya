...
<?php require_once("$root/include/sidebar.php");?>
        ...
        <div class="content-wrapper">
              ...
              <section class="content-header">
               ...
               <div class="col-sm-4 text-center  ">
                <a href="http://chanakya.lab/templates/bill/add.php" class="btn btn-primary btn-lg" role="button">Create  bill</a>
               </div>

               <div class="col-sm-4 text-center  ">
                <a href="http://chanakya.lab/templates/bill/special.php" class="btn btn-primary btn-lg" role="button">Create  special bill</a>
               </div>
               </div>
