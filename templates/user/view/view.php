    ...
    <div class="panel panel-primary">
      ...
      <div class="panel with-nav-tabs panel-primary">
            ...
            <div class="box-header">
              <h3 class="text-center">Available staff in Chanakya diagnostics</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                else
                {
                  ...
                  <td><a href="http://chanakya.lab/templates/user/edit/editDetails.php?s_id=<?php echo $single_staff['id'];?>" role="button" class="btn btn-primary">view details</a>
                  </td>                  
                  </tr> 
