...
<head>
  ...
  <link rel="shortcut icon" href="/chanakya/dist/img/favicon (2).ico" type="image/x-icon">
  <link rel="icon" href="/chanakya/dist/img/favicon (2).ico" type="image/x-icon">
  <!-- Bootstrap 3.3.6 -->
  <link rel="stylesheet" href="/chanakya/bootstrap/css/bootstrap.min.css">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="/chanakya/plugins/font-awesome/css/font-awesome.min.css">
  <!-- Ionicons -->
  <link rel="stylesheet" href="/chanakya/plugins/ionicons/css/ionicons.min.css">
  <!-- Theme style -->
  <link rel="stylesheet" href="/chanakya/dist/css/AdminLTE.min.css">
  <!-- AdminLTE Skins. We have chosen the skin-blue for this starter
        page. However, you can choose any other skin. Make sure you
        apply the skin class to the body tag so the changes take effect.
  -->
  <link rel="stylesheet" href="/chanakya/dist/css/skins/skin-blue.min.css">

  <!-- daterange picker -->
  <link rel="stylesheet" href="/chanakya/plugins/daterangepicker/daterangepicker.css">


  <link href="/chanakya/plugins/vex-master/dist/css/vex.css" rel="stylesheet" />
  <link href="/chanakya/plugins/vex-master/dist/css/vex-theme-os.css" rel="stylesheet" />
